...
Encore
    ...
    .addEntry('delete.comment', './assets/js/components/delete.comment.js')
    ...
    //to see the real path of an image you can get it from assets.yaml => manifest.json
    //1. put the images in assets/images
    //2. yarn watch it will build the images in build
    //3. in template, use : {{ asset('build/images/name_of_the_image.jpg) }}
    .copyFiles({
        from: './assets/images',
